        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="col-span-2">
                <div class="mb-4 md:mb-0 w-full aspect-video mx-auto relative rounded-lg">
                    ...
                    @if ($post->image)
                        <img class="absolute left-0 top-0 w-full h-full z-0 object-cover" src="{{ Storage::url($post->image->url) }}"
                            alt="">
                    @else
                    ...
                    <div class="p-4 absolute bottom-0 left-0 z-20">
                        ...
                        <div class="flex mt-3">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-400 text-xs"> {{$post->created_at->format('l jS \\of F Y h:i A'); }}</p>
                            </div>
                        </div>
                    </div>
                </div>
