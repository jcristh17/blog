                                ...
                                <div class="relative ml-3" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" x-on:click.away="open = false"
                                        ...
                                        <a class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                            id="user-menu-item-0" href="{{ route('profile.show') }}">Profile</a>
                                        @can('admin.home')
                                            <a class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                                id="user-menu-item-0" href="{{ route('admin.home') }}">Dashboard</a>
                                        @endcan
                                        @can('admin.home')
                                            <a class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                                id="user-menu-item-0" href="{{ route('admin.dash') }}">Dashboard v2</a>
                                        @endcan
            ...
            <div class="md:hidden" id="mobile-menu" x-show="open" x-on:click.away="open = false">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        ...
                        <a class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"
                            href="{{ route('logout') }}" @click.prevent="$root.submit();">Logout</a>
                    </div>
                </div>
            </div>
        </nav>
