                ...
                @foreach ($comments as $comment)
                    <div
                        ...
                        <div>
                            ...
                            <x-danger-button title="Delete this comment" class="bg-transparent hover:bg-transparent border-none focus:border-none float-right cursor-pointer" wire:click="deletecomment({{ $comment }})">
