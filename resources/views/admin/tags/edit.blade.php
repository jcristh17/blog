<x-admin-layout>
    ...
    <div
        ...
        <h2 class="text-center font-semibold text-2xl lg:text-3xl text-gray-800">
            <i class="fa-regular fa-fw fa-bookmark mr-2 mb-4"></i> Edit tag form
        </h2>
        {!! Form::model($tag, ['route' => ['admin.tags.update', $tag], 'method' => 'PUT']) !!}
        @include('admin.tags.partials.form')
        <x-buttons.primary-button class="btn-primary mt-2" type="submit">Update tag</x-buttons.primary-button>
        {!! Form::close() !!}
    </div>
